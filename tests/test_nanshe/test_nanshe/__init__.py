...
__all__ = [
    ...
    "test_debugging_tools", "test_extended_region_props", "test_HDF5_recorder",
    "test_HDF5_searchers", "test_HDF5_serializers", "test_nanshe_converter",
    "test_nanshe_learner", "test_nanshe_registerer",  # "test_nanshe_viewer",
