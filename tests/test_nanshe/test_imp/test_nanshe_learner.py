...
import nanshe.imp.nanshe_learner
...
class TestNansheLearner(object):
    ...
    def test_main_1(self):
        executable = os.path.splitext(nanshe.imp.nanshe_learner.__file__)[0] + os.extsep + "py"

        argv = (executable, self.config_a_block_filename, self.hdf5_input_filepath, self.hdf5_output_filepath,)

        assert (0 == nanshe.imp.nanshe_learner.main(*argv))
    ...
    def test_generate_neurons_io_handler_1(self):
        nanshe.imp.nanshe_learner.generate_neurons_io_handler(self.hdf5_input_filepath, self.hdf5_output_filepath, self.config_a_block_filename)
    ...
    def test_generate_neurons_io_handler_2(self):
        nanshe.imp.nanshe_learner.generate_neurons_io_handler(self.hdf5_input_filepath, self.hdf5_output_filepath, self.config_blocks_filename)
    ...
    def test_generate_neurons_io_handler_3(self):
        ...
        nanshe.imp.nanshe_learner.generate_neurons_io_handler(self.hdf5_input_filepath, self.hdf5_output_filepath, self.config_blocks_drmaa_filename)
    ...
    def test_generate_neurons_io_handler_4(self):
        nanshe.imp.nanshe_learner.generate_neurons_io_handler(self.hdf5_input_3D_filepath, self.hdf5_output_3D_filepath, self.config_a_block_3D_filename)
    ...
    def test_generate_neurons_io_handler_5(self):
        nanshe.imp.nanshe_learner.generate_neurons_io_handler(self.hdf5_input_3D_filepath, self.hdf5_output_3D_filepath, self.config_blocks_3D_filename)
    ...
    def test_generate_neurons_io_handler_6(self):
        ...
        nanshe.imp.nanshe_learner.generate_neurons_io_handler(self.hdf5_input_3D_filepath, self.hdf5_output_3D_filepath, self.config_blocks_3D_drmaa_filename)
    ...
    def test_generate_neurons_a_block_1(self):
        nanshe.imp.nanshe_learner.generate_neurons_a_block(self.hdf5_input_filepath, self.hdf5_output_filepath, **self.config_a_block)
    ...
    def test_generate_neurons_a_block_2(self):
        nanshe.imp.nanshe_learner.generate_neurons_a_block(self.hdf5_input_3D_filepath, self.hdf5_output_3D_filepath, **self.config_a_block_3D)
    ...
    def test_generate_neurons_blocks_1(self):
        nanshe.imp.nanshe_learner.generate_neurons_blocks(self.hdf5_input_filepath, self.hdf5_output_filepath, **self.config_blocks["generate_neurons_blocks"])
    ...
    def test_generate_neurons_blocks_2(self):
        ...
        nanshe.imp.nanshe_learner.generate_neurons_blocks(self.hdf5_input_filepath, self.hdf5_output_filepath, **self.config_blocks_drmaa["generate_neurons_blocks"])
    ...
    def test_generate_neurons_blocks_3(self):
        nanshe.imp.nanshe_learner.generate_neurons_blocks(self.hdf5_input_3D_filepath, self.hdf5_output_3D_filepath, **self.config_blocks_3D["generate_neurons_blocks"])
    ...
    def test_generate_neurons_blocks_4(self):
        ...
        nanshe.imp.nanshe_learner.generate_neurons_blocks(self.hdf5_input_3D_filepath, self.hdf5_output_3D_filepath, **self.config_blocks_3D_drmaa["generate_neurons_blocks"])
    ...
    def test_generate_neurons_1(self):
        with h5py.File(self.hdf5_output_filename, "a") as output_file_handle:
            ...
            nanshe.imp.nanshe_learner.generate_neurons.resume_logger = resume_logger
            nanshe.imp.nanshe_learner.generate_neurons.recorders.array_debug_recorder = array_debug_recorder
            nanshe.imp.nanshe_learner.generate_neurons(self.image_stack, **self.config_a_block["generate_neurons"])
    ...
    def test_generate_neurons_2(self):
        with h5py.File(self.hdf5_output_3D_filename, "a") as output_file_handle:
            ...
            nanshe.imp.nanshe_learner.generate_neurons.resume_logger = resume_logger
            nanshe.imp.nanshe_learner.generate_neurons.recorders.array_debug_recorder = array_debug_recorder
            nanshe.imp.nanshe_learner.generate_neurons(self.image_stack3, **self.config_a_block_3D["generate_neurons"])
