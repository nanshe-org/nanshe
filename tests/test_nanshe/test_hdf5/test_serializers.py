...
import nanshe.hdf5.serializers
...
class TestSerializers(object):
    ...
    def test_create_numpy_structured_array_in_HDF5_1(self):
        ...
        nanshe.hdf5.serializers.create_numpy_structured_array_in_HDF5(self.temp_hdf5_file, "data", data1)

        assert ("data" in self.temp_hdf5_file)
        assert (data1 == self.temp_hdf5_file["data"].value).all()

        try:
            nanshe.hdf5.serializers.create_numpy_structured_array_in_HDF5(self.temp_hdf5_file, "data", data2)
        except:
            assert (True)
        else:
            assert (False)
        ...
        try:
            nanshe.hdf5.serializers.create_numpy_structured_array_in_HDF5(self.temp_hdf5_file, "data", data2, overwrite=True)
        except:
            assert (False)
        else:
            assert (True)
    ...
    def test_read_numpy_structured_array_from_HDF5_1(self):
        ...
        data2 = nanshe.hdf5.serializers.read_numpy_structured_array_from_HDF5(self.temp_hdf5_file, "data")
        ...
        data3 = nanshe.hdf5.serializers.read_numpy_structured_array_from_HDF5(self.temp_hdf5_file, "data_ref")
        ...
        data4 = nanshe.hdf5.serializers.read_numpy_structured_array_from_HDF5(self.temp_hdf5_file, "data_rref")
        ...
        data5 = nanshe.hdf5.serializers.read_numpy_structured_array_from_HDF5(self.temp_hdf5_file2, "data_lref")
        ...
        data6 = nanshe.hdf5.serializers.read_numpy_structured_array_from_HDF5(self.temp_hdf5_file2, "data_lrref")
...
class TestHDF5MaskedDataset(object):
    ...
    def test_create(self):
        ...
        a = nanshe.hdf5.serializers.HDF5MaskedDataset(
