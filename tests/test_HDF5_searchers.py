...
class TestHDF5Searchers(object):
    ...
    def test_get_matching_paths(self):
        all_matched = nanshe.HDF5_searchers.get_matching_paths(self.temp_hdf5_file, u"/test/[0-9]{3}/group/[0-9]/data")
    ...
    def test_get_matching_paths_groups(self):
        all_matched = nanshe.HDF5_searchers.get_matching_paths_groups(self.temp_hdf5_file, u"/test/[0-9]{3}/group/[0-9]/data")
    ...
    def test_get_matching_grouped_paths_found(self):
        all_matched = nanshe.HDF5_searchers.get_matching_grouped_paths_found(self.temp_hdf5_file, u"/test/[0-9]{3}/group/[0-9]/data")
